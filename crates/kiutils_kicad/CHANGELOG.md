...
## [0.3.0](https://github.com/Milind220/kiutils-rs/compare/kiutils_kicad-v0.2.1...kiutils_kicad-v0.3.0) - 2026-03-29

### Added

- [**breaking**] replace summary ASTs with typed models across formats ([#25](https://github.com/Milind220/kiutils-rs/pull/25))

## [0.2.1](https://github.com/Milind220/kiutils-rs/compare/kiutils_kicad-v0.2.0...kiutils_kicad-v0.2.1) - 2026-03-05

### Added

- *(kicad)* add schematic symbol instance read/write APIs ([#23](https://github.com/Milind220/kiutils-rs/pull/23))
